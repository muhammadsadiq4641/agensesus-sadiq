...
import LiquidityImg from "@assets/images/liquidity-mob.svg";
import ProtocolImg from "@assets/images/protocol-mob.svg";
import MarketingImg from "@assets/images/marketing-mob.svg";
import ComunityImg from "@assets/images/comunity-mob.svg";
import LiquidityMob2 from "@assets/images/liquidity-mob-2.svg";
import ProtocolMob2 from "@assets/images/protocol-mob-2.svg";
import MarketingMob2 from "@assets/images/marketing-mob-2.svg";
import ComunityMob2 from "@assets/images/comunity-mob-2.svg";
import {
  motion,
  useAnimation,
  useMotionValue,
...
import BorderTop from "@assets/images/verticle-border.png";
...
const TokenomicsMobile = () => {
  ...
  return (
    <div id="tokenomicsmob" className="container" ref={containerRef}>
      <motion.div
      ...
      >
        {/* Card 1 */}
        <div className="relative w-full h-[320px] waghera">
          <Image
            src={BorderTop}
            alt="BorderTop"
          ...
          <motion.div
            ...
            className="h-[320px] origin-center overflow-hidden"
          >
            <Image
              src={LiquidityImg}
              alt="LiquidityImg"
              className="h-[320px] object-cover mx-auto max-[550px]:hidden"
            />
            <Image
              src={LiquidityMob2}
              alt="LiquidityMob2"
              className="h-[320px] object-cover mx-auto hidden max-[550px]:block"
            />
          </motion.div>
          <h4 className="text-white text-2xl font-bold absolute left-10 text-center  sm:top-14 bottom-10">
            LIQUIDITY
          </h4>
        ...
        <div className="relative w-full h-[320px] waghera">
          ...
          <h4 className="text-white text-2xl font-bold absolute left-10 sm:top-14 bottom-10 text-center">
